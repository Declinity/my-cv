export const Text = {
    CoverLetter: {
        ...
        cosmient: (<div>
            ...
            <p className="TNR" style={{"textAlign": "center", "paddingTop": "10px"}}>While 5 days is nowhere near sufficient to learn the complexities of AI, I’ve apprehended all the basics like the theoretical aspects behind it and the Python libraries and frameworks behind it. In my own time I’ve examined many of <a href="http://www.doc.mmu.ac.uk/STAFF/S.Lynch/DSAP_Jupyter_Notebook.html">Dr. Lynch’s programs</a> as practice. As per the person specifications, these are the current abilities I have:</p>
            <br />
